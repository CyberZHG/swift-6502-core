...
final class OpBNETests: XCTestCase {
    ...
    func testBNERelative() throws {
        self.memory.setBytes(start: 0x0000, bytes: [0xD0, 0x02])
        self.cpu.PC = 0x0000
        self.cpu.Z = false
        ...
        self.memory.setBytes(start: 0x0000, bytes: [0xD0, 0x69])
        self.cpu.PC = 0x0000
        self.cpu.Z = true
