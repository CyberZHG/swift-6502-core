...
final class OpBCSTests: XCTestCase {
    ...
    func testBCSRelative() throws {
        self.memory.setBytes(start: 0x0000, bytes: [0xB0, 0x02])
        self.cpu.PC = 0x0000
        self.cpu.C = true
        ...
        self.memory.setBytes(start: 0x0000, bytes: [0xB0, 0x69])
        self.cpu.PC = 0x0000
        self.cpu.C = false
