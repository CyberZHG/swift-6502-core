...
final class OpBEQTests: XCTestCase {
    ...
    func testBEQRelative() throws {
        self.memory.setBytes(start: 0x0000, bytes: [0xF0, 0x02])
        self.cpu.PC = 0x0000
        self.cpu.Z = true
        ...
        self.memory.setBytes(start: 0x0000, bytes: [0xF0, 0x69])
        self.cpu.PC = 0x0000
        self.cpu.Z = false
